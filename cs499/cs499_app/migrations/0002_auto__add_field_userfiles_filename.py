...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFiles.filename'
        db.add_column('cs499_app_userfiles', 'filename',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 3, 7, 0, 0), max_length='40'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFiles.filename'
        db.delete_column('cs499_app_userfiles', 'filename')
